; var __global__ = this; var Environment = (function (a) {
  var a = {
    ...
    hasDocument: !(typeof window === "undefined") &&
                 !(typeof window.document === "undefined"),
    hasActiveXObject: !(typeof window === "undefined") &&
  ...
  a.IsIE = (a.hasWindow && a.hasAlert && a.hasActiveXObject);
  a.IsHTA = function () {
    if (a.IsBrowser) {
      var htaApp = document.getElementsByTagName("HTA:APPLICATION").length ? 
        document.getElementsByTagName("HTA:APPLICATION") :
        document.getElementsByTagName("APPLICATION");
