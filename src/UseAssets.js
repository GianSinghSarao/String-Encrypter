addEvent(window, "load", function () {
  setTimeout(function () {
    ...
    // meaning the titlebar might not have been created yet, because it is 
    // dynamically created during a load event handler.
    // a settimeout is the simplest (and perhaps only) way to handle this 
    // (in IE5)
